...
var setGen = function(gen){	
	var pgen = gen.id;	
	localStorage.setItem('prodArea',pgen);
	var sPath=window.location.pathname;
	if(pgen == 'Men'){	localStorage.setItem('producttype','MClothes');}
	if(pgen == 'Women'){	localStorage.setItem('producttype','WClothes');}
	if(pgen == 'Kids'){	localStorage.setItem('producttype','KClothes');}
}

var myFunction =  function (menCloth,menbag){	
if(menbag=='menbag' || menbag=='menclothes' )	
{ 
 localStorage.setItem('prodArea','Men');
}
if(menbag=='womenbag' || menbag=='womenclothes' )	
{ 
localStorage.setItem('prodArea','Women');
}	
if(menbag=='womenbag' || menbag=='womenclothes' )	
{ 
localStorage.setItem('prodArea','Kids');
}
	s = localStorage.getItem('user');
	clothname = menCloth.id;	
     var productA =localStorage.getItem('prodArea');	
	 if(productA == 'Women'){
	 menuItems = womenmenu[clothname];	
	 }
	 else if(productA == 'Men')
	 {
		 menuItems = menmenu[clothname];	
	 }
	 else if(productA == 'Kids')
	 {
		 menuItems = kidsmenu[clothname];	
	 }
	 name = menuItems[0].name;
	 price = menuItems[0].price;
	 type = menuItems[0].type;
	 id = menuItems[0].id;	 
	 $('span#modal-title').text(name);
	 $('span#pricetitle').text(price);
	 $('span#typetitle').text(type);
...
var womenmenu = {	
    0: [
        {
			...
			imageurl:"images/womenclothes/lt1.jpg",
			itemsize:I_size
    ...
    1: [
	{
         Product: 'Women Clothes',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt2.jpg",
			itemsize:I_size
			}
    ],
    2: [
         {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt3.jpg",
			itemsize:I_size
    ...
    3: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt4.jpg",
			itemsize:I_size
        }
    ]    ,
    4: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt5.jpg",
			itemsize:I_size
        }
    ...
    5: [
        {  Product: 'Women Clothes',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt6.jpg",
			itemsize:I_size
        }
    ],
	6: [
        {  Product: 'Women Clothes',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt7.jpg",
			itemsize:I_size
        }
    ],
	7: [
        {  Product: 'Women Clothes',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt8.jpg",
			itemsize:I_size
        }
    ],
	8: [
        {  Product: 'Women Clothes',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenclothes/lt9.jpg",
			itemsize:I_size
        }
    ],
	 9: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag1.jpg",
			itemsize:I_size			
        }
    ...
    10: [
	{
         Product: 'Women Bag',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag2.jpg",
			itemsize:I_size	
			}
    ],
    11: [
         {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag3.jpg",
			itemsize:I_size
    ...
    12: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag4.jpg",
			itemsize:I_size
        }
    ]    ,
    13: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag5.jpg",
			itemsize:I_size
        }
    ...
    14: [
        {  Product: 'Women Bag',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag6.jpg",
			itemsize:I_size
        }
    ],
	15: [
        {  Product: 'Women Bag',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag7.jpg",
			itemsize:I_size
        }
    ],
	16: [
        {  Product: 'Women Bag',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag8.jpg",
			itemsize:I_size
        }
    ],
	17: [
        {  Product: 'Women Bag',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenbags/lbag9.jpg",
			itemsize:I_size
        }
    ],
	18: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws1.jpg",
			itemsize:I_size
    ...
    19: [
	{
         Product: 'Women Shoe',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws2.jpg",
			itemsize:I_size
			}
    ],
    20: [
         {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws3.jpg",
			itemsize:I_size
    ...
    21: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws4.jpg",
			itemsize:I_size
        }
    ]    ,
    22: [
        {
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws5.jpg",
			itemsize:I_size
        }
    ...
    23: [
        {  Product: 'Women Shoe',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws6.jpg",
			itemsize:I_size
        }
    ],
	24: [
        {  Product: 'Women Shoe',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws7.jpg",
			itemsize:I_size
        }
    ],
	25: [
        {  Product: 'Women Shoe',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws8.jpg",
			itemsize:I_size
        }
    ],
	26: [
        {  Product: 'Women Shoe',
			...
			quantity: input,
			totalprice: totalprice,
			imageurl:"images/womenshoes/ws9.jpg",
			itemsize:I_size
        }
    ]
